...
def query_llm_with_function_call(prompt: str, model: str, api_key: str, api_base: str = "", decoding_cfg: dict = {}, max_tokens: int = 4000) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        if "hosted_vllm" in model.lower() or "litellm_proxy" in model.lower():
        ...
        if decoding_cfg:
            completion_args.update(decoding_cfg)
